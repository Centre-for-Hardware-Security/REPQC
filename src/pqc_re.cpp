...
int main(int argc, char** argv) { 
	if (argc != 7) {
		...
		cout << "the correct usage is " << argv[0] << "file.zscore file.grouping file.depends min_group_size tolerance_pct n_candidates" << std::endl;
		cout << "Example: " << argv[0] << " ../results/input.zscore ../results/input.grouping ../results/input.depends 64 0.1 30" << std::endl;
		return 0;
	}
...
void printGroupHits() {
	...
	for (auto& it1 : mygroups) {
		if (it1.score==highest_score) {
			...
			logfile << "the winner with " << highest_score << " score is group " << count << endl;
